...
void Help(){
    ...
    printf("3. DROP_OFF    - Mengantarkan item di tumpukan teratas tas jika lokasi sesuai\n");
    ...
    printf("10. SAVE_GAME  - Menyimpan state dari permainan yang sedang dijalankan\n");
